...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Eror:Toxic
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https://www.facebook.com/sourov.islam.7906')
    else:
...
def menu():
	...
	print '\033[1;94m[13]\033[1;91m Update Tech Eror Toxic'
...
def action():
	...
	if bch =='':
		...
		os.system('xdg-open https://https://www.facebook.com/sourov.islam.7906')
		login()
	elif bch =='0':
		exb()
	else:
